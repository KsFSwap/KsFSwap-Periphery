...
import { IKsfSwapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
import { abi as IKsfSwapV3PoolABI } from '@KsfSwap/v3-core/artifacts/contracts/interfaces/IKsfSwapV3Pool.sol/IKsfSwapV3Pool.json'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IKsfSwapV3Pool, IKsfSwapV3Pool, IKsfSwapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IKsfSwapV3PoolABI, wallet)) as [
      IKsfSwapV3Pool,
      IKsfSwapV3Pool,
      IKsfSwapV3Pool
    ]
  ...
  let pools: [IKsfSwapV3Pool, IKsfSwapV3Pool, IKsfSwapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestKsfSwapV3Callee')
