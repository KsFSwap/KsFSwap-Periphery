...
import '@KsfSwap/v2-core/contracts/interfaces/IKsfSwapV2Pair.sol';
...
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IKsfSwapV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IKsfSwapV2Pair(params.pair).burn(address(this));
